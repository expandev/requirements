...
class LangChainAdapter:
    ...
    def __init__(self, llm: LLM):
        ...
        Args:
            llm (LLM): A instância de LLM a ser adaptada
        """
        self.llm = llm
...
def create_langchain_compatible_llm(llm: LLM) -> LangChainAdapter:
    """
    ...
    Returns:
        LangChainAdapter: O adaptador compatível com LangChain
    """
