"""
SystemPrompt Module - Integration of agent profiles with task definitions.
...
class SystemPrompt(BaseModel):
    ...
    agent_profile: AgentDefinition = Field(
    ...
    llm_config: Optional[LLM] = Field(
        default=None,
        description="Language model configuration (optional)"
    )
    
    @model_validator(mode='after')
    def ensure_llm_config(self) -> 'SystemPrompt':
        """
