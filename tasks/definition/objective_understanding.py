...
class ObjectiveUnderstanding(TaskProxy):
    """
    ...
    def __init__(self, demand: str, task_key=1, knowledge_base_path=default_knowledge_base_path):
        """
        ...
        config = ExpandevConfigProvider(description_file_path, knowledge_base_path=knowledge_base_path)
